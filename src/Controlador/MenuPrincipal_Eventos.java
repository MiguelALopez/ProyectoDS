...
public class MenuPrincipal_Eventos
{
	...
	public MenuPrincipal_Eventos(final MenuPrincipal menuPrincipal)
	{
        ...
        // Para iniciar sesion con el boton, o al dar enter cuando estamos sobre
		// el campo de la contraseña
		ActionListener aIniciarSesion
			= new ActionListener()
			{
				@Override
		...
		this.menuPrincipal.bIniciarSesion.addActionListener(aIniciarSesion);
		this.menuPrincipal.pfClave.addActionListener(aIniciarSesion);
...
//        );
		...
		this.menuPrincipal.bRegistrarVenta.addActionListener(
			new ActionListener()
			{
				...
				public void actionPerformed(ActionEvent ae)
				{
					menuPrincipal.registrarVenta = new RegistrarVenta();
					menuPrincipal.registrarVenta_Eventos = new RegistrarVenta_Eventos(menuPrincipal.registrarVenta);
					menuPrincipal.registrarVenta.setLocationRelativeTo(null);
